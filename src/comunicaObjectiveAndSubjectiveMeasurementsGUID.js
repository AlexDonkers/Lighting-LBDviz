...
export async function queryComunicaObjectiveAndSubjectiveMeasurementsGUID() {
...
select * where {
    ?o lbd:globalId `+JSON.stringify(document.getElementById("selected-guid").innerHTML)+` ;
    bop:hasComfort ?Comfort ;
    bop:hasBrightness ?Brightness_Perception  ;
    bop:hasGlare ?Glare_Perception ;
    bop:hasLuminance ?Luminance_Level ;
...
window.queryComunicaObjectiveAndSubjectiveMeasurementsGUID = queryComunicaObjectiveAndSubjectiveMeasurementsGUID;
