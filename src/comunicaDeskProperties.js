...
export async function queryComunicaDeskProperties() {
...
select ?Number ?Type ?Category ?Element where {
...
window.queryComunicaDeskProperties = queryComunicaDeskProperties;
